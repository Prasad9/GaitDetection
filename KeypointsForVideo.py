...
class KeypointsForVideo:
    def __init__(self, params):
        self._pose_detection = PoseDetection(params)
    ...
    def run_inference(self, image, crop_region, crop_size):
        ...
        input_image = self._crop_and_resize(tf.expand_dims(image, axis=0),
                                            crop_region, crop_size=crop_size)
        # Run model inference.
        keypoints_with_scores = self._pose_detection.run_movenet(input_image)
